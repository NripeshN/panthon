...
def vulnTest():
    ...
    TESTS = (
        ...
        (
            (
                '-u <url> --data="code=1" --code=200 --technique=B --banner --no-cast'
                " --flush-session"
            ),
        ...
        (
            (
                '-c <config> --flush-session --output-dir="<tmpdir>" --smart --roles'
                ' --statements --hostname --privileges --sql-query="SELECT'
                " '\u0161u\u0107uraj'\" --technique=U"
            ),
            (
                ": '\u0161u\u0107uraj'",
        ...
        (
            (
                "-u <url> --flush-session --sql-query=\"SELECT '\u0161u\u0107uraj'\""
                " --technique=B --no-escape --string=luther --unstable"
            ),
            (": '\u0161u\u0107uraj'",),
        ),
        (
        ...
        (
            (
                '-u "<url>&id2=1" -p id2 -v 5 --flush-session --level=5 --text-only'
                ' --test-filter="AND boolean-based blind - WHERE or HAVING clause'
                ' (MySQL comment)"'
            ),
            ("~1AND",),
        ),
        ...
        (
            (
                "-l <log> --flush-session --keep-alive --skip-waf -vvvvv --technique=U"
                " --union-from=users --banner --parse-errors"
            ),
            (
                "banner: '3.",
        ...
        (
            (
                '-u <base> --flush-session --data="id=1&_=Eewef6oh" --chunked'
                " --randomize=_ --random-agent --banner"
            ),
            (
        ...
        (
            (
                '-u <base64> -p id --base64=id --data="base64=true" --flush-session'
                " --banner --technique=B"
            ),
            ("banner: '3.",),
        ),
        ...
        (
            (
                "-u <url> --flush-session --banner --technique=B --disable-precon"
        ...
        (
            (
                "-u <url> --flush-session --encoding=gbk --banner --technique=B"
                " --first=1 --last=2"
            ),
            ("banner: '3.'",),
        ),
        (
            (
                "-u <url> --flush-session --encoding=ascii --forms --crawl=2"
                " --threads=2 --banner"
            ),
            (
                "total of 2 targets",
        ...
        (
            (
                '-u <base> --flush-session -H "Foo: Bar" -H "Sna: Fu"'
                ' --data="<root><param name=\\"id\\" value=\\"1*\\"/></root>"'
                ' --union-char=1 --mobile --answers="smartphone=3" --banner --smart'
                " -v 5"
            ),
            (
                "might be injectable",
        ...
        (
            (
                "-u <base> --flush-session --technique=BU --method=PUT"
                ' --data="a=1;id=1;b=2" --param-del=";" --skip-static --har=<tmpfile>'
                " --dump -T users --start=1 --stop=2"
            ),
            (
                "might be injectable",
                "Parameter: id (PUT)",
        ...
        (
            (
                "-u <url> --flush-session --banner --invalid-logical --technique=B"
                ' --predict-output --test-filter="OR boolean" --tamper=space2dash'
            ),
            ("banner: '3.", " LIKE "),
        ),
        (
            (
                "-u <url> --flush-session"
                ' --cookie="PHPSESSID=d41d8cd98f00b204e9800998ecf8427e; id=1*; id2=2"'
                " --tables --union-cols=3"
            ),
            (
                "might be injectable",
        ...
        (
            (
                "-u <url> --flush-session --null-connection --technique=B"
                " --tamper=between,randomcase --banner --count -T users"
            ),
            (
        ...
        (
            (
                '-u <url> --flush-session --parse-errors --test-filter="subquery"'
                ' --eval="import hashlib; id2=2;'
                ' id3=hashlib.md5(id.encode()).hexdigest()" --referer="localhost"'
            ),
            (
                "might be injectable",
                ": syntax error",
        ...
        (
            (
                "-u <url> --banner --schema --dump -T users --binary-fields=surname"
                ' --where "id>3"'
            ),
            (
                "banner: '3.",
        ...
        (
            (
                "-u <url> --technique=U --fresh-queries --force-partial --dump -T users"
                ' --dump-format=HTML --answers="crack=n" -v 3'
            ),
            (
                "performed 6 queries",
                "nameisnull",
        ...
        (
            (
                '-u <url> -z "tec=B" --hex --fresh-queries --threads=4'
        ...
        (
            (
                '-d "<direct>" --flush-session --dump -T users --dump-format=SQLITE'
                ' --binary-fields=name --where "id=3"'
            ),
            (
                "7775",
        ...
        (
            (
                '-d "<direct>" --flush-session --banner --schema --sql-query="UPDATE'
                " users SET name='foobar' WHERE id=5; SELECT * FROM users; SELECT"
                ' 987654321"'
            ),
            (
                "banner: '3.",
    ...
    for options, checks in TESTS:
        ...
        if IS_WIN and "uraj" in options:
            options = options.replace("\u0161u\u0107uraj", "sucuraj")
            checks = [check.replace("\u0161u\u0107uraj", "sucuraj") for check in checks]
