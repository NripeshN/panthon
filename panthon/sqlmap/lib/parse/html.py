...
class HTMLHandler(ContentHandler):
    """This class defines methods to parse the input HTML page to fingerprint
    ...
    def startElement(self, name, attrs):
        ...
        if name == "dbms":
            ...
            if (
                "|" in regexp
                or kb.cache.regex[regexp]
                in (self._lower_page or kb.cache.regex[regexp])
            ) and re.search(regexp, self._urldecoded_page, re.I):
