...
class KeepAliveHandler:
    ...
    def _request_closed(self, request, host, connection):
        """Tells us that this request is now closed and the the connection is
    ...
    def _reuse_connection(self, h, req, host):
        ...
        returns.  However, if an unexpected exception occurs, it will
        close and remove the connection before re-raising.
        """
        try:
            self._start_transaction(h, req)
            r = h.getresponse()
