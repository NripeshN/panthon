...
class Enumeration(GenericEnumeration):
    ...
    def getCurrentUser(self):
        warnMsg = (
            "on Raima Database Manager it is not possible to enumerate the current user"
        )
        logger.warning(warnMsg)

    def getCurrentDb(self):
        warnMsg = (
            "on Raima Database Manager it is not possible to get name of the current"
            " database"
        )
        logger.warning(warnMsg)
    ...
    def isDba(self, user=None):
        warnMsg = (
            "on Raima Database Manager it is not possible to test if current user"
            " is DBA"
        )
        logger.warning(warnMsg)
    ...
    def getPasswordHashes(self):
        warnMsg = (
            "on Raima Database Manager it is not possible to enumerate the user"
            " password hashes"
        )
        logger.warning(warnMsg)
    ...
    def getDbs(self):
        warnMsg = (
            "on Raima Database Manager it is not possible to enumerate databases (use"
            " only '--tables')"
        )
        logger.warning(warnMsg)
    ...
    def getHostname(self):
        warnMsg = (
            "on Raima Database Manager it is not possible to enumerate the hostname"
        )
        logger.warning(warnMsg)

    def getStatements(self):
        warnMsg = (
            "on Raima Database Manager it is not possible to enumerate the SQL"
            " statements"
        )
        logger.warning(warnMsg)
