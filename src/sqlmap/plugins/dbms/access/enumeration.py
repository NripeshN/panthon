...
class Enumeration(GenericEnumeration):
    ...
    def getPasswordHashes(self):
        warnMsg = (
            "on Microsoft Access it is not possible to enumerate the user password"
            " hashes"
        )
        logger.warning(warnMsg)
    ...
    def getDbs(self):
        warnMsg = (
            "on Microsoft Access it is not possible to enumerate databases (use only"
            " '--tables')"
        )
        logger.warning(warnMsg)
    ...
    def getStatements(self):
        warnMsg = (
            "on Microsoft Access it is not possible to enumerate the SQL statements"
        )
        logger.warning(warnMsg)
